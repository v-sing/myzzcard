...
;(function (global, factory) {
   ...
   typeof define === 'function' && define.amd ? define('moment/locale/zh-cn-cn',['../moment'], factory) :
...
define('table',['jquery', 'bootstrap', 'moment', 'moment/locale/zh-cn-cn', 'bootstrap-table', 'bootstrap-table-lang', 'bootstrap-table-export', 'bootstrap-table-commonsearch', 'bootstrap-table-template'], function ($, undefined, Moment) {
    var Table = {
        list: {},
