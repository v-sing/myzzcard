...
class LargeModel extends Model
{
    ...
    public function inLarge($data){
        ...
        $insert_sql = "insert into large_deal (traceid,customid,chargeamount,chargenu,
    ...
    public function search($traceid=null,$status=null){
        ...
        $sql = "select * from large_deal {$where}";
        $data = $this->query($sql);
        if($data){
            return $data;
        }else{
    ...
    public function ud($status,$traceid,$comment=null){
        ...
        $sql = "update large_deal set status={$status}{$msg} 
    ...
    public function del($traceid){
        ...
        $sql = "update large_deal set isdel=1 
    ...
    public function up($data,$where){
        ...
        $updata = rtrim($updata,",");
        $sql = "update large_deal set $updata  where $where";
    ...
    public function inData($data){
        ...
        $values = rtrim($values,",");
        $sql = "insert into large_deal (traceid,customid,chargeamount,";
