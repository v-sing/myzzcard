...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/Public/receiptImg/',
            'upload_url' => $this->get_full_url().'/Public/receiptImg/',
            ...
            'inline_file_types' => '/\.(gif|jpe?g|png|xls|xlsx)$/i',
            ...
            'accept_file_types' =>  '/\.(gif|jpe?g|png|xls|xlsx)$/i',
            ...
            'image_versions' => array(
		        ...
		        */
                'thumbnail' => array(
                    ...
                    'max_width' => 1080, // either specify width, or set to 0. Then width is automatically adjusted - keeping aspect ratio to a specified max_height.
                    'max_height' => 780 // either specify height, or set to 0. Then height is automatically adjusted - keeping aspect ratio to a specified max_width.
                )
            ),
            'print_response' => true
        );
    ...
    protected function handle_file_upload($uploaded_file, &$name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            $file->name = md5(substr($file->name,0,-3)).md5(microtime()).substr($name,-4);
            $name = $file->name;
    ...
    public function head() {
        ...
        $this->header('RedisCache-Control: no-store, no-cache, must-revalidate');
